...
function Sobre() {
  return (
    <div className="body">
      <NavBar />
      <h1 className="Titulo">Conheça o Radar da Caridade</h1>
      <div className="sobre">
        <p>
          O projeto "Radar da Caridade" é uma iniciativa que visa dar resposta à
          necessidade urgente de algo que a humanidade sempre enfrentou: A
        ...
        <h2>Como funciona?</h2>
        <p>
          Basta cadastrar o tipo de caridade que você irá realizar, o local e a
          hora! O mapa ficará marcado com a sua ação e assim mais pessoas
        ...
        <p>
          ...
          experiência como Gerente de Operações e Service Desk. Tendo inclusive
          já desempenhado suas funções na Globo.com, Banco BBM e Ministério
          Público do Estado do Rio de Janeiro. De formação católica, sempre foi
          incentivado por seus pais à pratica da caridade.
        </p>
      </div>
    </div>
  );
